    ...
    <tr>
        ...
        <td class="otgsi_register_product_wrap" align="center" valign="top">            
            ...
            <div class="alignright">
                ...
                <a class="update_site_key_js button-secondary" href="#" data-repository=<?php echo esc_attr($repository_id) ?> data-nonce="<?php echo wp_create_nonce('update_site_key_' . $repository_id) ?>"><?php _e('Check for updates', 'installer') ?></a>
            </div>
