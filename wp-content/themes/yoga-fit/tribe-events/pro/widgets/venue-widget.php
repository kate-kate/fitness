...
<div class="tribe-venue-widget-wrapper">
	...
	<p class="tribe-events-widget-link">
		<a href="<?php esc_url( tribe_get_venue_link( $venue_ID, false ) ); ?>"><?php printf(__( 'View all Events at this %s','the-events-calendar'), $events_label_plural, tribe_get_venue_label_singular() ); ?></a>
	</p>
</div>
