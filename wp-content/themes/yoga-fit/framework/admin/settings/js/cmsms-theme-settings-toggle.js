...
(function ($) { 
	...
	$('#' + cmsms_settings.shortname + '_error_bg_img_enable').bind('change', function () { 
	...
	/* Appearance 'Header Styles' Tab Fields Load */
	if ($('input[name*="' + cmsms_settings.shortname + '_header_styles"]:checked').val() === 'l_logo') {
		$('#' + cmsms_settings.shortname + '_header_middle_html').parents('tr').show();
		
		if ($('#' + cmsms_settings.shortname + '_header_middle_html').is(':not(:checked)')) {
			$('#' + cmsms_settings.shortname + '_header_middle_add_html').parents('tr').hide();
		} else {
			$('#' + cmsms_settings.shortname + '_header_middle_add_html').parents('tr').show();
		}
	} else if ($('input[name*="' + cmsms_settings.shortname + '_header_styles"]:checked').val() === 'c_logo') {
		$('#' + cmsms_settings.shortname + '_header_middle_html').parents('tr').hide();
		$('#' + cmsms_settings.shortname + '_header_middle_add_html').parents('tr').hide();
	} else if ($('input[name*="' + cmsms_settings.shortname + '_header_styles"]:checked').val() === 's_logo') {
		$('#' + cmsms_settings.shortname + '_header_middle_html').parents('tr').hide();
		$('#' + cmsms_settings.shortname + '_header_middle_add_html').parents('tr').hide();
	}
	
	
	/* Appearance 'Header Styles' Tab Fields Change */
	...
	$('#' + cmsms_settings.shortname + '_header_middle_html').bind('change', function () {
		if ($('#' + cmsms_settings.shortname + '_header_middle_html').is(':not(:checked)')) {
			$('#' + cmsms_settings.shortname + '_header_middle_add_html').parents('tr').hide();
		} else {
			$('#' + cmsms_settings.shortname + '_header_middle_add_html').parents('tr').show();
	...
	if ($('#' + cmsms_settings.shortname + '_tt_event_hours').is(':not(:checked)')) {
		$('#' + cmsms_settings.shortname + '_tt_event_hours_title').parents('tr').hide();
	}
	
	/* Single Posts 'Timetable Event' Tab 'Hours' Field Change */
	$('#' + cmsms_settings.shortname + '_tt_event_hours').bind('change', function () { 
		if ($(this).is(':checked')) {
			$('#' + cmsms_settings.shortname + '_tt_event_hours_title').parents('tr').show();
		} else {
			$('#' + cmsms_settings.shortname + '_tt_event_hours_title').parents('tr').hide();
		}
	} );
