...
function cmsms_form_field_fn($args = array()) {
	...
	case 'wpml':
		echo '<div class="wrap otgsi_downloads_form">' .
			'<span>' . __("This plugin makes it easy to build multilingual sites and run them. It's powerful enough for corporate sites, yet simple for blogs.", 'yoga-fit') . '</span>';
	
		// CONFIG
		$config['template'] = 'compact'; //required
		$config['product_name'] = 'WPML'; 
		$config['box_title'] = 'Multilingual Yoga Fit';
		$config['name'] = 'Yoga Fit'; //name of theme/plugin 
		$config['box_description'] = 'Yoga Fit theme is fully compatible with WPML - the WordPress Multilingual plugin. WPML lets you add languages to your existing sites and includes advanced translation management.'; 
